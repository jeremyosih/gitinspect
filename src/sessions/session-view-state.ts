import type { SessionLeaseState } from "@/db/session-leases"
import type { SessionRuntimeStatus } from "@/types/storage"
...
export function deriveRecoveryIntent(
...
export function shouldDisplayConversationStreaming(
  state: ActiveSessionViewState
): boolean {
